...
Script to determine the coordinates of Titan in order to help the observation of the IDS Proposal SI2015a02 
"""
print 'The script shows the possition of Titan in order to help' 
print 'the observation of the IDS Proposal SI2015a02'
